	...
	var App = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      'div',
	      null,
	      _react2['default'].createElement(_2['default'], _extends({ timeout: timeout, enabled: enabled }, { callback: this.inc })),
	      _react2['default'].createElement('input', { type: 'number', step: '200', min: '200', max: '5000', value: this.state.timeout,
	        onChange: function (_ref) {
	          var value = _ref.target.value;
	          return _this.setState({ timeout: parseInt(value, 10) });
	        } }),
	      ' ',
	      _react2['default'].createElement(
	        'button',
	        { disabled: enabled, onClick: function () {
	            return _this.setState({ enabled: true });
	          } },
	        'Start'
	      ),
	      ' ',
	      _react2['default'].createElement(
	        'button',
	        { disabled: !enabled, onClick: function () {
	            return _this.setState({ enabled: false });
	          } },
	        'Stop'
	      ),
	      ' ',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactInterval = __webpack_require__(154);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactLibReactComponentWithPureRenderMixin = __webpack_require__(155);
